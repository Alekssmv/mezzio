    ...
    public function process($data): void
    {
        ...
        try {
            ...
            $accessToken = $accountService
                ->findOrCreate((int) $params['account_id'])->amo_access_jwt;
            ...
            if ($accessToken === null) {
                echo $messagesPrefix .
                    'Access token is not found in account with id ' .
                    $account->account_id . PHP_EOL;
                return;
            }
            ...
            if ($apiClient->webhooks()->get() === null) {
                ...
                echo $messagesPrefix .
                    'Webhook already exists in account with id ' .
                    $account->account_id .
                    PHP_EOL;
                return;
            }
            ...
            echo $messagesPrefix .
                'Webhook was not added to account with id ' .
                $account->account_id .
                PHP_EOL;
